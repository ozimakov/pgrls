...
def test_snapshot_version_is_19() -> None:
    # Bumped 18 → 19 to add top-level immutable_functions (user-defined
    # provolatile='i' functions, for SEC046). v3–v23 baselines still load
    # (Schema.from_snapshot accepts 3 through 23). v23 added per-view grants
    # for the VIEW004 verify --mode escalation path.
